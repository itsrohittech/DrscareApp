    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!validateFields()) {
                    Toast.makeText(DuplicateActivity.this, "Please select an option in each category", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(DuplicateActivity.this, "Total Score: " + totalScore, Toast.LENGTH_SHORT).show();
                Intent ultrasoundIntent = new Intent(DuplicateActivity.this, score_results.class);
